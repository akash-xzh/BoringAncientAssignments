...
exports.ifProp = exports.PropState = exports.PropLayer = exports.LayerGenerator = void 0;
const utils_1 = require("../utils");
const Meta = utils_1.meta;
...
exports.LayerGenerator = LayerGenerator;
class PropLayer {
    id;
    disabled;
    BaseHP;
...
class PropState {
    ...
    sum(...layerNames) {
        ...
        this.layers.forEach((layer) => {
            if (layer.disabled)
                return;
            if (layerNames.length && !layerNames.includes(layer.id))
                return;
            for (let prop in layer) {
                if (prop === 'id' || prop === 'disabled')
                    continue;
                // @ts-ignore
                sum[prop] += layer[prop];
            }
