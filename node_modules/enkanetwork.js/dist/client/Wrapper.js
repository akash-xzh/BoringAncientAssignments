...
const GenshinClient_1 = require("./Genshin/GenshinClient");
const StarRailClient_1 = require("./StarRail/StarRailClient");
/**
...
class Wrapper {
     ...
     */
    constructor(options) {
        this.genshin = new GenshinClient_1.GenshinClient(options);
        this.starrail = new StarRailClient_1.StarRailClient(options);
    }
}
