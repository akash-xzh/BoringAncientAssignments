...
class Characters {
    ...
    constructor(data, language) {
        ...
        this.element = genshinFinder.character(charDepot || this.characterId).element;
        ...
        this.assets = genshinFinder.character(charDepot || this.characterId).assets;
        this.costumeId = data.costumeId || "";
        this.name = genshinFinder.character(charDepot || this.characterId).name;
    }
}
